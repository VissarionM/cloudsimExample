...
import org.cloudbus.cloudsim.VmAllocationPolicyBestFit;
...
public class CloudSimExample6 {
	...
	private static Datacenter createDatacenter(String name) {
		...
		// peList3.add(new Pe(0, new PeProvisionerSimple(mips))); // need to store Pe id
		// and MIPS Rating
		...
		// new VmSchedulerTimeSharedOverSubscription(peList3)
		// )
		// ); // third machine
		...
		// new Host(
		// hostId,
		// //new CpuProvisionerSimple(peList2),
		// new RamProvisionerSimple(ram),
		// new BwProvisionerSimple(bw),
		// storage,
		// peList1,
